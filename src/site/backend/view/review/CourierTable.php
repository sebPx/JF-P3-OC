		...
		<div class="li-review-content">
			<div class="li-review-top">
				<div class="li-review-left">
					<div class='review-author' >De : <strong><?php echo $get['post'][$key]['name']." ".$get['post'][$key]['surname']; ?></strong></div>
					<div class='review-date' >Le : <?php echo $get['post'][$key]['date']; ?></div>
				</div>
				<div class="li-review-center">
					<div class='review-title' >Sujet : <strong><?php echo $get['post'][$key]['subject']; ?></strong></div>
					<div class='review-resume' >E-mail : <?php echo $get['post'][$key]['email']; ?></div>
				</div>
			</div>
