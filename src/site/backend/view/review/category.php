...
<section id="add-post-screen">
	<article id="review">
		<div class="review-contact-left">
			<label class="title"><h6>1 - Ajouter une catégorie :</h6></label>
			<div id="infoArea">te</div>
				<?php
					include ('../form/formCategory.php');
				?>
			</br>
		</div>
		<div class="review-right">
			<label class="title"><h6>2 - Liste des categories :</h6></label>
					...
					<ul>
						<?php
							foreach ($get['post'] as $key => $value) {
								include ('../review/categoryTable.php');
							}
						?>
					</ul>
			</div>
