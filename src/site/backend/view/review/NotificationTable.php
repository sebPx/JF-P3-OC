		...
		<div class="li-review-content">
			<div class="li-review-top">
				<div class="li-review-left">
					<div class='review-author' >De : <strong><?php echo $get['post'][$key]['sender']; ?></strong></div>
				...
				<?php 
					foreach ($get['index'] as $key2 => $value2) {
						if ($get['index'][$key2]['code'] == $get['post'][$key]['content']) {?>					
							<div class='review-title' >Sujet : <strong><?php echo $get['index'][$key]['content']; ?></strong></div>
				<?php 	}
					}
				 ?>						
					<div class='review-resume' >A propos de : <?php echo $get['post'][$key]['subject']; ?></div>
				</div>
			</div>
