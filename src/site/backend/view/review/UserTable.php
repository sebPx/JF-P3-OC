		...
		<div class="li-review-content">
			<div class="li-review-top">
				<div class="li-review-left">
					<div class='review-author' >Identifiant : <strong><?php echo $get['post'][$key]['login']; ?></strong></div>
					<div class='review-date' >Le : <?php echo $get['post'][$key]['date']; ?></div>
				</div>
				<div class="li-review-center">
					<div class='review-title' >Nom - Prénom : <strong><?php echo $get['post'][$key]['surname'] ." ".$get['post'][$key]['name'] ; ?></strong></div>
					<div class='review-resume' >Grade : <?php echo $get['post'][$key]['level']; ?></div>
				</div>
			</div>
