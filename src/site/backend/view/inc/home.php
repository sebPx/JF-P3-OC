...
<div id="admin-home">
	<div id="admin-home-panel">
						...
						<div class="last-post">
							...
							<?php
								foreach ($get['post'] as $key => $value) {
									include ('../src/site/backend/view/jacket/post/articleJacket.php');
								  }
							?>
						</div>
					</div>
					...
					<div class="reg-logs-table">
						<ul>
							<?php foreach ($get['log'] as $key => $value) {
									include ('../src/site/backend/view/jacket/log/logList.php');
								  }
							?>
						</ul>
					</div>
		...
		<div class="admin-home-helper">
			<h4>Découvrez prochainement l'assitant d'administration !</h4>
		</div>
	</div>
</div>
