	...
	<div name ='nxs-jacket-inner' class ='nxs-jacket-inner'>
	  	...
	  	<div class ='nxs-jacket-content'>
			...
			<div class ='nxs-jacket-edit-bar'>
				<button  id="delete-<?php echo $get['post'][$key]['id']; ?>" value="Article" class="delete_btn">Supprimer</button>
				<button  id="classify-<?php echo $get['post'][$key]['id']; ?>" value="article" class="edit_btn">Archiver</button>
				<button  id="edit-<?php echo $get['post'][$key]['id']; ?>" value="Article" onclick="popup('large');" class="edit_btn">Modifier</button>
	  		</div>
	  	</div>
