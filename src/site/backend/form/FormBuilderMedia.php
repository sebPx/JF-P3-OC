  ...
  public function build(){
    ...
    $this->form->add(new fieldText([
        ...
        'validators' => [
          ...
          new validatorNotNull('Veuillez spécifier la description du média.')
        ]
    ]));
